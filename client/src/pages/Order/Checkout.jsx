...
//                 <button
//                   type="submit"
//                   class="text-white mt-5 bg-[#f96822] hover:bg-[#f0824a]  font-medium rounded-lg text-sm sm:w-auto w-full px-5 py-2.5 text-center shadow-xl"
//                 >
//                   Save Changes
//                 </button>
//               </form>
...
const Checkout = () => {
  ...
  return (
    <section className="container mx-auto flex flex-col items-center">
      <div className="relative flex justify-between items-center w-full max-w-xl mt-20 mb-8 px-6">
        ...
        <Link
          ...
          className={`${
            location.pathname === "/checkout/shipping"
              ? "bg-[#f96822] text-white hover:bg-[#ff9763]"
              : "bg-[#F0F2F5] text-gray-800 hover:bg-[#f96822] hover:text-white"
