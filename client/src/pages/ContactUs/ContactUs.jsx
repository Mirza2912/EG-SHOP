...
const ContactUs = () => {
  ...
  return (
    <>
      ...
      {/* Contact Us page */}
      <section className="lg:w-[80%] xl:w-[65%] container mx-auto">
        <div className="flex justify-center my-6">
          <p className="text-3xl font-semibold md:text-4xl text-center md:text-start md:max-w-[600px]">
            NICE PROJECT? GET IN TOUCH! WILL CONTACT YOU SOON
          </p>
        </div>
        <div className="rounded-2xl shadow-2xl  p-16">
          ...
          <form class="mx-auto mt-4">
            ...
            <div className="w-full flex items-center justify-center">
              <button
                type="submit"
                class="text-white mt-5 bg-[#f96822] hover:bg-[#f0824a]  font-medium rounded-lg text-sm w-[80%] sm:w-[40%] px-5 py-2.5 text-center"
              >
                Send Message
              </button>
            </div>
      ...
      <section className="container lg:w-[80%] mx-auto mt-12 mb-8">
