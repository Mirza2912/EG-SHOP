      ...
      <header className="bg-[#F0F2F5] relative">
        <div className="container mx-auto flex justify-between p-5 items-center">
          ...
          <ul className="hidden md:flex items-center text-lg justify-center">
            <Link
              to={"/"}
              className="mr-5 text-gray-500 hover:text-black cursor-pointer"
            >
              Home
            </Link>
            <Link
            ...
            <Link
              to={"/about"}
              className="mr-5 relative text-gray-500 hover:text-black cursor-pointer flex justify-center items-center"
            >
              About
            </Link>
            <Link
